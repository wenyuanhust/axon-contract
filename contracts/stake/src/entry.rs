...
pub fn main() -> Result<(), Error> {
    ...
    debug!("metadata_type_id:{:?}, staker_identity: {:?}", metadata_type_id, staker_identity);
...
impl Secp256k1Eth {
    pub fn verify_alone(
        ...
        debug!("verify_alone pubkey: {:?}, pubkey_hash: {:?}, eth_address: {:?}", pubkey, pubkey_hash, eth_address);
